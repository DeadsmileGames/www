        ...
        <div className={`mobile-menu ${open ? 'mobile-menu--open' : ''}`} aria-hidden={!open} inert={open ? undefined : ''}>
            ...
            >
                ...
                <div className="mobile-menu__footer">
                    {status === 'authenticated' ? (
                        <Link to="/account" className="mobile-menu__account" onClick={onClose} aria-label="My account">
                            <UserCircle size={32} weight="bold" />
                        </Link>
                    ) : (
                        <Link to="/login" className="mobile-menu__account" onClick={onClose} aria-label="Sign in">
                            <UserCircle size={32} weight="bold" />
                        </Link>
                    )}
                </div>
